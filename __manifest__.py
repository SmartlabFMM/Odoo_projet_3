{
    ...
    'assets': {
        'web.assets_backend': [
            ...
            'health_monitoring/static/src/js/measurements_session_view.js',
            ...
            'health_monitoring/static/src/xml/measurements_session_view.xml',
            ...
            'health_monitoring/static/src/css/alerts_dashboard.css',
            'health_monitoring/static/src/xml/alerts_dashboard.xml',
            'health_monitoring/static/src/js/alerts_dashboard.js',
        ],
    },
